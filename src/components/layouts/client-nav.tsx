/**
ID: ui_0007
Barra de navegación inferior diseñada para la PWA del cliente, con acceso rápido a las secciones principales.
*/
...
const navItems = [
    { label: "Inicio", href: "/client/home", icon: Home },
    { label: "Premios", href: "/client/rewards", icon: Gift },
    { label: "Escanear", href: "/client/scan", icon: QrCode },
